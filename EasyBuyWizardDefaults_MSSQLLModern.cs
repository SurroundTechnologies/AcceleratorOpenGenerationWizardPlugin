        ...
        internal override void SetColumnRules(Mode mode, AB_GenerationModuleEntity moduleEntity, AB_GenerationViewColumnEntity viewColumnEntity)
        {
            ...
            switch (mode)
            {
                case Mode.InitialSetup:
                    ...
                    if ((viewColumnEntity.Name.Substring(viewColumnEntity.Name.Length - 2) == "DT") && ((viewColumnEntity.Type == "NUMERIC(8.0)") || viewColumnEntity.Type == "DATE(4)" || viewColumnEntity.Type == "numeric"))
                    {
                        ...
                        if ((viewColumnEntity.Type == "NUMERIC(8.0)" || viewColumnEntity.Type == "numeric"))
                        {
                    ...
                    if ((viewColumnEntity.Name.Substring(viewColumnEntity.Name.Length - 2) == "TM") && (viewColumnEntity.Type == "NUMERIC(6.0)" || viewColumnEntity.Type == "numeric"))
                    {
